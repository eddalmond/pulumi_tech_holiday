    ...
    def new_resource(self, args: pulumi.runtime.MockResourceArgs):
        ...
        # S3 Bucket Versioning
            ...
            outputs.update({
                ...
                "versioning_configuration": args.inputs.get("versioning_configuration", {}),
            })
        ...
        # S3 Bucket Public Access Block
            ...
            outputs.update({
                ...
                "restrict_public_buckets": args.inputs.get("restrict_public_buckets", True),
            })
        ...
        # API Gateway Integration mocking
            ...
            outputs.update({
                ...
                "resource_id": args.inputs.get("resource_id"),
                "http_method": args.inputs.get("http_method"),
                "integration_http_method": args.inputs.get("integration_http_method"),
